...
if __name__ == '__main__':
    ...
    cmd_parser.add_argument('-t', '--threshold', metavar='threshold', type=float, default=0.2, help='voxels with confidence lower than the threshold are not displayed')
    ...
    cmd_parser.add_argument('-mc', '--max-component', metavar='max_component', type=int, default=5, help='whether to keep only the maximal connected component, where voxels of distance no larger than `DISTANCE` are considered connected. Set to 0 to disable this function.')
